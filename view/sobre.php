            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-10">
                    <div class="gradiente p-4 rounded-3 shadow-sm">
                        ...
                        <p>O NESPlay surgiu de uma idéia do aluno <a class="link-body-emphasis texto-gradiente" href="https://github.com/John-Roberto">João Roberto</a>, em parceria com <a class="link-body-emphasis texto-gradiente" href="https://github.com/GustoVasconcelos">Augusto Vasconcelos</a>, ambos estudantes de Análise e Desenvolvimento em Sistemas na Faculdade de Tecnologia de Presidente Prudente (Fatec PP), sendo o Trabalho Prático 2 - Sistema WEB Integrado com Banco de dados, desenvolvido no 2° Bimestre da Matéria Eletiva - Linguagem de Programação IV INTERNET, ministrada pelo professor <a class="link-body-emphasis texto-gradiente" href="https://github.com/brunoslima">Me. Bruno Santos de Lima</a>, no ano de 2025.</p>
                        ...
                        <p>O site usa um emulador opensource escrito interamente em Javascript por <a class="link-body-emphasis texto-gradiente" href="https://github.com/bfirsh">Ben Firshman (bfirsh)</a> , chamado <a class="link-body-emphasis texto-gradiente" href="https://github.com/bfirsh/jsnes">JSNES</a> para emular as <i>roms</i>.</p>
                    </div>
                </div>
            </div>
        </main>
